...
IF NOT EXISTS (
    ...
    WHERE conname = 'FK_AccountingOutbox_SubscriptionInvoices_TenantId_Subscription~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AccountingOutbox_SubscriptionRevenueActions_TenantId_Subscr~'
      AND conrelid = to_regclass('platform."AccountingOutbox"')
) THEN
ALTER TABLE ONLY platform."AccountingOutbox"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BillingStatementLines_BillingStatements_BillingStatementId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BillingStatements_RateCards_RateCardId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BillingStatements_Tenants_TenantId'
      AND conrelid = to_regclass('platform."BillingStatements"')
) THEN
ALTER TABLE ONLY platform."BillingStatements"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PlatformBrowserTrusts_PlatformUsers_PlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PlatformMfaChallenges_PlatformUsers_PlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PlatformMfaCredentials_PlatformUsers_PlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PlatformMfaRecoveryCodes_PlatformUsers_PlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PlatformSessions_PlatformUsers_PlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ProvisioningSteps_ProvisioningExecutions_ExecutionId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RateCardLines_RateCards_RateCardId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionCreditNotes_SubscriptionInvoices_SubscriptionIn~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionInvoices_BillingStatements_BillingStatementId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionInvoices_SubscriptionTaxRules_TaxRuleId_TaxRule~'
      AND conrelid = to_regclass('platform."SubscriptionInvoices"')
) THEN
ALTER TABLE ONLY platform."SubscriptionInvoices"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionInvoices_Tenants_TenantId'
      AND conrelid = to_regclass('platform."SubscriptionInvoices"')
) THEN
ALTER TABLE ONLY platform."SubscriptionInvoices"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionPayments_SubscriptionInvoices_SubscriptionInvoi~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionRevenueActions_PlatformUsers_ApprovedByPlatform~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionRevenueActions_PlatformUsers_ProposedByPlatform~'
      AND conrelid = to_regclass('platform."SubscriptionRevenueActions"')
) THEN
ALTER TABLE ONLY platform."SubscriptionRevenueActions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionRevenueActions_SubscriptionInvoices_TenantId_Su~'
      AND conrelid = to_regclass('platform."SubscriptionRevenueActions"')
) THEN
ALTER TABLE ONLY platform."SubscriptionRevenueActions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionTaxRules_PlatformUsers_ApprovedByPlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SubscriptionTaxRules_PlatformUsers_ProposedByPlatformUserId'
      AND conrelid = to_regclass('platform."SubscriptionTaxRules"')
) THEN
ALTER TABLE ONLY platform."SubscriptionTaxRules"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupportTicketLinks_SupportTickets_SupportTicketId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupportTicketNotes_SupportTickets_SupportTicketId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupportTickets_PlatformUsers_AssignedToPlatformUserId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupportTickets_PlatformUsers_OpenedByPlatformUserId'
      AND conrelid = to_regclass('platform."SupportTickets"')
) THEN
ALTER TABLE ONLY platform."SupportTickets"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupportTickets_Tenants_TenantId'
      AND conrelid = to_regclass('platform."SupportTickets"')
) THEN
ALTER TABLE ONLY platform."SupportTickets"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_TenantDataAssets_Tenants_TenantId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_TenantDataRecoveryEvidence_TenantDataAssets_TenantId_Tenant~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_TenantDataRecoveryEvidence_Tenants_TenantId'
      AND conrelid = to_regclass('platform."TenantDataRecoveryEvidence"')
) THEN
ALTER TABLE ONLY platform."TenantDataRecoveryEvidence"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_TenantDeletionCertificates_Tenants_TenantId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_TenantMeterSourcePolicies_Tenants_TenantId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Tenants_Plans_PlanId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageCoverageSegments_Tenants_TenantId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEventRatings_Plans_PlanId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEventRatings_RateCardLines_RateCardLineId'
      AND conrelid = to_regclass('platform."UsageEventRatings"')
) THEN
ALTER TABLE ONLY platform."UsageEventRatings"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEventRatings_RateCards_RateCardId'
      AND conrelid = to_regclass('platform."UsageEventRatings"')
) THEN
ALTER TABLE ONLY platform."UsageEventRatings"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEventRatings_UsageEvents_TenantId_UsageEventId'
      AND conrelid = to_regclass('platform."UsageEventRatings"')
) THEN
ALTER TABLE ONLY platform."UsageEventRatings"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEvents_RateCardLines_RateCardLineId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEvents_RateCards_RateCardId'
      AND conrelid = to_regclass('platform."UsageEvents"')
) THEN
ALTER TABLE ONLY platform."UsageEvents"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEvents_Tenants_TenantId'
      AND conrelid = to_regclass('platform."UsageEvents"')
) THEN
ALTER TABLE ONLY platform."UsageEvents"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageEvents_UsageEvents_TenantId_AdjustsUsageEventId'
      AND conrelid = to_regclass('platform."UsageEvents"')
) THEN
ALTER TABLE ONLY platform."UsageEvents"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UsageMinuteAggregates_Tenants_TenantId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AgentPolicies_Currency_BusinessUnitId_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiBudgetPeriods_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiCallAttempts_AiRequests_BusinessUnitId_RequestId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiProcessingPolicies_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiProviderAuthorizations_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiRequests_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiRequests_ExtractionJobs_BusinessUnitId_ExtractionJobId'
      AND conrelid = to_regclass('public."AiRequests"')
) THEN
ALTER TABLE ONLY public."AiRequests"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_AiRequests_source_document_occurrences_BusinessUnitId_Sourc~'
      AND conrelid = to_regclass('public."AiRequests"')
) THEN
ALTER TABLE ONLY public."AiRequests"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAccounts_Currency_BusinessUnitId_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAccounts_LedgerAccounts_BusinessUnitId_LedgerAccountId'
      AND conrelid = to_regclass('public."BankAccounts"')
) THEN
ALTER TABLE ONLY public."BankAccounts"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustmentDistributions_BankAdjustments_BusinessUnitId_~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustmentDistributions_LedgerAccounts_BusinessUnitId_L~'
      AND conrelid = to_regclass('public."BankAdjustmentDistributions"')
) THEN
ALTER TABLE ONLY public."BankAdjustmentDistributions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_AccountingPeriods_BusinessUnitId_Accounting~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_BankAccounts_BusinessUnitId_BankAccountId'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_BankStatementLines_BusinessUnitId_BankState~'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_JournalEntries_BusinessUnitId_JournalEntryId'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_JournalEntries_BusinessUnitId_ReversalJourn~'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_JournalEntryLines_BusinessUnitId_BankJourna~'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankAdjustments_JournalEntryLines_BusinessUnitId_ReversalBa~'
      AND conrelid = to_regclass('public."BankAdjustments"')
) THEN
ALTER TABLE ONLY public."BankAdjustments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankMatchingRules_BankAccounts_BusinessUnitId_BankAccountId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankMatchingRules_BankMatchingRules_BusinessUnitId_Supersed~'
      AND conrelid = to_regclass('public."BankMatchingRules"')
) THEN
ALTER TABLE ONLY public."BankMatchingRules"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankStatementImports_BankAccounts_BusinessUnitId_BankAccoun~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankStatementLines_BankStatements_BusinessUnitId_BankStatem~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankStatements_BankAccounts_BusinessUnitId_BankAccountId_Cu~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankStatements_BankStatementImports_BusinessUnitId_BankStat~'
      AND conrelid = to_regclass('public."BankStatements"')
) THEN
ALTER TABLE ONLY public."BankStatements"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BankStatements_Currency_BusinessUnitId_CurrencyId'
      AND conrelid = to_regclass('public."BankStatements"')
) THEN
ALTER TABLE ONLY public."BankStatements"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BoqAssemblyComponents_BoqAssemblies_BoqAssemblyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BoqItems_BoqSections_BoqSectionId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_BoqSections_BoqDocuments_BoqDocumentId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_City_BusinessUnit'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CollectionControls_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CollectionControls_Customers_CustomerId'
      AND conrelid = to_regclass('public."CollectionControls"')
) THEN
ALTER TABLE ONLY public."CollectionControls"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CollectionControls_ReceivableDocuments_BusinessUnitId_Recei~'
      AND conrelid = to_regclass('public."CollectionControls"')
) THEN
ALTER TABLE ONLY public."CollectionControls"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CommercialCases_BusinessUnits_BusinessUnitID'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Country_BusinessUnit'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwardLineAllocations_CustomerAwards_BusinessUnitId_~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwardLineAllocations_CustomerPurchaseOrderLines_Bus~'
      AND conrelid = to_regclass('public."CustomerAwardLineAllocations"')
) THEN
ALTER TABLE ONLY public."CustomerAwardLineAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwardLineAllocations_QuoteItems_QuoteItemId'
      AND conrelid = to_regclass('public."CustomerAwardLineAllocations"')
) THEN
ALTER TABLE ONLY public."CustomerAwardLineAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_CommercialCases_BusinessUnitId_CommercialCas~'
      AND conrelid = to_regclass('public."CustomerAwards"')
) THEN
ALTER TABLE ONLY public."CustomerAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_Currency_BusinessUnitId_CurrencyId'
      AND conrelid = to_regclass('public."CustomerAwards"')
) THEN
ALTER TABLE ONLY public."CustomerAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_CustomerPurchaseOrders_BusinessUnitId_Custom~'
      AND conrelid = to_regclass('public."CustomerAwards"')
) THEN
ALTER TABLE ONLY public."CustomerAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerAwards"')
) THEN
ALTER TABLE ONLY public."CustomerAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerAwards_Quotes_BusinessUnitId_QuoteId'
      AND conrelid = to_regclass('public."CustomerAwards"')
) THEN
ALTER TABLE ONLY public."CustomerAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerCollectionProfiles_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerCollectionProfiles_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerCollectionProfiles"')
) THEN
ALTER TABLE ONLY public."CustomerCollectionProfiles"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerCollectionProfiles_DunningPolicies_BusinessUnitId_D~'
      AND conrelid = to_regclass('public."CustomerCollectionProfiles"')
) THEN
ALTER TABLE ONLY public."CustomerCollectionProfiles"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerCollectionProfiles_FinanceCommunicationContacts_Bus~'
      AND conrelid = to_regclass('public."CustomerCollectionProfiles"')
) THEN
ALTER TABLE ONLY public."CustomerCollectionProfiles"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_BankAccounts_BusinessUnitId_BankAccountId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_CommercialCases_BusinessUnitId_CommercialC~'
      AND conrelid = to_regclass('public."CustomerPayments"')
) THEN
ALTER TABLE ONLY public."CustomerPayments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_Currency_CurrencyId'
      AND conrelid = to_regclass('public."CustomerPayments"')
) THEN
ALTER TABLE ONLY public."CustomerPayments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerPayments"')
) THEN
ALTER TABLE ONLY public."CustomerPayments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_JournalEntries_BusinessUnitId_JournalEntry~'
      AND conrelid = to_regclass('public."CustomerPayments"')
) THEN
ALTER TABLE ONLY public."CustomerPayments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPayments_JournalEntries_BusinessUnitId_ReversalJour~'
      AND conrelid = to_regclass('public."CustomerPayments"')
) THEN
ALTER TABLE ONLY public."CustomerPayments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrderLines_CustomerPurchaseOrders_BusinessU~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrderLines_Products_ProductId'
      AND conrelid = to_regclass('public."CustomerPurchaseOrderLines"')
) THEN
ALTER TABLE ONLY public."CustomerPurchaseOrderLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrderLines_setUOM_BusinessUnitId_UomId'
      AND conrelid = to_regclass('public."CustomerPurchaseOrderLines"')
) THEN
ALTER TABLE ONLY public."CustomerPurchaseOrderLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrders_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrders_CommercialCases_BusinessUnitId_Comme~'
      AND conrelid = to_regclass('public."CustomerPurchaseOrders"')
) THEN
ALTER TABLE ONLY public."CustomerPurchaseOrders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrders_Currency_BusinessUnitId_CurrencyId'
      AND conrelid = to_regclass('public."CustomerPurchaseOrders"')
) THEN
ALTER TABLE ONLY public."CustomerPurchaseOrders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerPurchaseOrders_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerPurchaseOrders"')
) THEN
ALTER TABLE ONLY public."CustomerPurchaseOrders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_BankAccounts_BusinessUnitId_BankAccountId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_CommercialCases_BusinessUnitId_CommercialCa~'
      AND conrelid = to_regclass('public."CustomerRefunds"')
) THEN
ALTER TABLE ONLY public."CustomerRefunds"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_Currency_CurrencyId'
      AND conrelid = to_regclass('public."CustomerRefunds"')
) THEN
ALTER TABLE ONLY public."CustomerRefunds"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_CustomerPayments_BusinessUnitId_SourcePayme~'
      AND conrelid = to_regclass('public."CustomerRefunds"')
) THEN
ALTER TABLE ONLY public."CustomerRefunds"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerRefunds"')
) THEN
ALTER TABLE ONLY public."CustomerRefunds"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerRefunds_JournalEntries_BusinessUnitId_JournalEntryId'
      AND conrelid = to_regclass('public."CustomerRefunds"')
) THEN
ALTER TABLE ONLY public."CustomerRefunds"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerStatementLines_CustomerStatements_BusinessUnitId_Cu~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerStatements_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerStatements_CustomerStatements_BusinessUnitId_Supers~'
      AND conrelid = to_regclass('public."CustomerStatements"')
) THEN
ALTER TABLE ONLY public."CustomerStatements"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_CustomerStatements_Customers_CustomerId'
      AND conrelid = to_regclass('public."CustomerStatements"')
) THEN
ALTER TABLE ONLY public."CustomerStatements"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Customers_AccountTeam'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Customers_RegionState'
      AND conrelid = to_regclass('public."Customers"')
) THEN
ALTER TABLE ONLY public."Customers"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningCases_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningCases_CustomerStatements_BusinessUnitId_CustomerStat~'
      AND conrelid = to_regclass('public."DunningCases"')
) THEN
ALTER TABLE ONLY public."DunningCases"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningCases_Customers_CustomerId'
      AND conrelid = to_regclass('public."DunningCases"')
) THEN
ALTER TABLE ONLY public."DunningCases"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningCases_DunningPolicies_BusinessUnitId_DunningPolicyId'
      AND conrelid = to_regclass('public."DunningCases"')
) THEN
ALTER TABLE ONLY public."DunningCases"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningDeliveryAttempts_DunningNotices_BusinessUnitId_Dunni~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningNotices_CustomerStatements_BusinessUnitId_CustomerSt~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningNotices_DunningCases_BusinessUnitId_DunningCaseId'
      AND conrelid = to_regclass('public."DunningNotices"')
) THEN
ALTER TABLE ONLY public."DunningNotices"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningNotices_FinanceCommunicationContacts_BusinessUnitId_~'
      AND conrelid = to_regclass('public."DunningNotices"')
) THEN
ALTER TABLE ONLY public."DunningNotices"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningPolicySteps_DunningPolicies_BusinessUnitId_DunningPo~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_CustomerCollectionProfiles_BusinessUnit~'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_CustomerStatements_BusinessUnitId_Custom'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_Customers_CustomerId'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_DunningCases_BusinessUnitId_DunningCaseI'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_DunningNotices_BusinessUnitId_DunningNot'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRunDecisions_DunningRuns_BusinessUnitId_DunningRunId'
      AND conrelid = to_regclass('public."DunningRunDecisions"')
) THEN
ALTER TABLE ONLY public."DunningRunDecisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_DunningRuns_DunningPolicies_BusinessUnitId_DunningPolicyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ExtractionCorpusEntries_LeadReviewAudits_LeadReviewAuditId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ExtractionJobs_source_document_occurrences_BusinessUnitId_S~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_FinanceCommunicationContacts_Customers_CustomerId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_FinanceOutboxMessages_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_IamAuditEvents_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Inventory_Products_Buid_ProductId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntries_AccountingPeriods_BusinessUnitId_AccountingP~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntries_Currency_FunctionalCurrencyId'
      AND conrelid = to_regclass('public."JournalEntries"')
) THEN
ALTER TABLE ONLY public."JournalEntries"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntries_Currency_Tenant'
      AND conrelid = to_regclass('public."JournalEntries"')
) THEN
ALTER TABLE ONLY public."JournalEntries"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntries_JournalEntries_BusinessUnitId_ReversesJourna~'
      AND conrelid = to_regclass('public."JournalEntries"')
) THEN
ALTER TABLE ONLY public."JournalEntries"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntryLines_Currency_Tenant'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntryLines_Currency_TransactionCurrencyId'
      AND conrelid = to_regclass('public."JournalEntryLines"')
) THEN
ALTER TABLE ONLY public."JournalEntryLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntryLines_JournalEntries_BusinessUnitId_JournalEntr~'
      AND conrelid = to_regclass('public."JournalEntryLines"')
) THEN
ALTER TABLE ONLY public."JournalEntryLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_JournalEntryLines_LedgerAccounts_BusinessUnitId_LedgerAccou~'
      AND conrelid = to_regclass('public."JournalEntryLines"')
) THEN
ALTER TABLE ONLY public."JournalEntryLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadIngestionOccurrences_ExtractionJobs_BusinessUnitId_Extr~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadIngestionOccurrences_LeadIngestionBatches_BusinessUnitI~'
      AND conrelid = to_regclass('public."LeadIngestionOccurrences"')
) THEN
ALTER TABLE ONLY public."LeadIngestionOccurrences"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadIngestionOccurrences_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public."LeadIngestionOccurrences"')
) THEN
ALTER TABLE ONLY public."LeadIngestionOccurrences"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadIngestionOccurrences_source_document_occurrences_Busine~'
      AND conrelid = to_regclass('public."LeadIngestionOccurrences"')
) THEN
ALTER TABLE ONLY public."LeadIngestionOccurrences"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadIngestionOccurrences_source_documents_BusinessUnitId_So~'
      AND conrelid = to_regclass('public."LeadIngestionOccurrences"')
) THEN
ALTER TABLE ONLY public."LeadIngestionOccurrences"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadItemRevisions_LeadRevisions_BusinessUnitId_LeadRevision~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadItems_Leads'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadMatchCandidates_LeadIngestionOccurrences_BusinessUnitId~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadMatchCandidates_Leads_BusinessUnitId_CandidateLeadId'
      AND conrelid = to_regclass('public."LeadMatchCandidates"')
) THEN
ALTER TABLE ONLY public."LeadMatchCandidates"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadOccurrenceDocuments_LeadIngestionOccurrences_BusinessUn~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadOccurrenceDocuments_source_documents_BusinessUnitId_Sou~'
      AND conrelid = to_regclass('public."LeadOccurrenceDocuments"')
) THEN
ALTER TABLE ONLY public."LeadOccurrenceDocuments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadReferenceConfigurations_BusinessUnits_BusinessUnitID'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadReviewAudits_Leads_BusinessUnitId_LeadId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadRevisionDifferences_LeadRevisions_BusinessUnitId_LeadRe~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadRevisionImpacts_LeadRevisions_BusinessUnitId_LeadRevisi~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadRevisionImpacts_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public."LeadRevisionImpacts"')
) THEN
ALTER TABLE ONLY public."LeadRevisionImpacts"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadRevisions_LeadIngestionOccurrences_BusinessUnitId_Estab~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadRevisions_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public."LeadRevisions"')
) THEN
ALTER TABLE ONLY public."LeadRevisions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadStatusHistories_BusinessUnits_BusinessUnitID'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadStatusHistories_CommercialCases_CommercialCaseID'
      AND conrelid = to_regclass('public."LeadStatusHistories"')
) THEN
ALTER TABLE ONLY public."LeadStatusHistories"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LeadStatusHistories_Leads_LeadID'
      AND conrelid = to_regclass('public."LeadStatusHistories"')
) THEN
ALTER TABLE ONLY public."LeadStatusHistories"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_CommercialCases_CommercialCaseId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_Contacts_BusinessUnitID_ContactID'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_Customers_BusinessUnitID_CustomerID'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_LeadRejectedReason'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_LeadRevisions_BusinessUnitID_CurrentRevisionId'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Leads_Setup_Master'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerAccounts_Currency_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerAccounts_Currency_Tenant'
      AND conrelid = to_regclass('public."LedgerAccounts"')
) THEN
ALTER TABLE ONLY public."LedgerAccounts"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerBooks_Currency_FunctionalCurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerBooks_Currency_Tenant'
      AND conrelid = to_regclass('public."LedgerBooks"')
) THEN
ALTER TABLE ONLY public."LedgerBooks"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerBooks_LedgerAccounts_BusinessUnitId_ReceivablesContro~'
      AND conrelid = to_regclass('public."LedgerBooks"')
) THEN
ALTER TABLE ONLY public."LedgerBooks"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_LedgerBooks_LedgerAccounts_BusinessUnitId_UnappliedCashAcco~'
      AND conrelid = to_regclass('public."LedgerBooks"')
) THEN
ALTER TABLE ONLY public."LedgerBooks"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_MasterDataChangeEvents_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_MasterDataFieldChanges_MasterDataChangeEvents_BusinessUnitI~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_OrderItems_CustomerAwardLineAllocations_CustomerAwardLineAl~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_OrderToCashAuditEvents_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_OrderToCashDocumentCounters_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Orders_CommercialCases_BusinessUnitID_CommercialCaseID'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Orders_CustomerAwards_BusinessUnitID_CustomerAwardID'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PaymentAllocations_CustomerPayments_BusinessUnitId_Customer~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PaymentAllocations_ReceivableDocuments_BusinessUnitId_Recei~'
      AND conrelid = to_regclass('public."PaymentAllocations"')
) THEN
ALTER TABLE ONLY public."PaymentAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ProductSubCategories_BusinessUnits'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Products_ProductSubCategories'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Products_setUOM'
      AND conrelid = to_regclass('public."Products"')
) THEN
ALTER TABLE ONLY public."Products"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PromisesToPay_CustomerPayments_BusinessUnitId_MatchedPayment'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_PromisesToPay_DunningCases_BusinessUnitId_DunningCaseId'
      AND conrelid = to_regclass('public."PromisesToPay"')
) THEN
ALTER TABLE ONLY public."PromisesToPay"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteConfiguration_BusinessUnit'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteItem_DiscountType'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteItems_Products'
      AND conrelid = to_regclass('public."QuoteItems"')
) THEN
ALTER TABLE ONLY public."QuoteItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteItems_Quotes'
      AND conrelid = to_regclass('public."QuoteItems"')
) THEN
ALTER TABLE ONLY public."QuoteItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteItems_RFQItems'
      AND conrelid = to_regclass('public."QuoteItems"')
) THEN
ALTER TABLE ONLY public."QuoteItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuotePriceAttestationLines_QuotePriceAttestations_BusinessU~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuotePriceAttestations_Quotes_BusinessUnitId_QuoteId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteRemovalRecords_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_QuoteValidityExtensions_Quotes_BusinessUnitId_QuoteId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quote_DiscountType'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quotes_BusinessUnits'
      AND conrelid = to_regclass('public."Quotes"')
) THEN
ALTER TABLE ONLY public."Quotes"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quotes_CommercialCases_BusinessUnitID_CommercialCaseID'
      AND conrelid = to_regclass('public."Quotes"')
) THEN
ALTER TABLE ONLY public."Quotes"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quotes_Currency'
      AND conrelid = to_regclass('public."Quotes"')
) THEN
ALTER TABLE ONLY public."Quotes"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quotes_Customers'
      AND conrelid = to_regclass('public."Quotes"')
) THEN
ALTER TABLE ONLY public."Quotes"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Quotes_Status'
      AND conrelid = to_regclass('public."Quotes"')
) THEN
ALTER TABLE ONLY public."Quotes"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQItems_Currency'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQItems_Product'
      AND conrelid = to_regclass('public."RFQItems"')
) THEN
ALTER TABLE ONLY public."RFQItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQItems_Supplier'
      AND conrelid = to_regclass('public."RFQItems"')
) THEN
ALTER TABLE ONLY public."RFQItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQItems_Warehouse'
      AND conrelid = to_regclass('public."RFQItems"')
) THEN
ALTER TABLE ONLY public."RFQItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQ_BusinessUnit'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQ_BusinessUnitID'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQ_CommercialCases_BusinessUnitID_CommercialCaseID'
      AND conrelid = to_regclass('public."RFQ"')
) THEN
ALTER TABLE ONLY public."RFQ"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_RFQ_Customers_CustomerID'
      AND conrelid = to_regclass('public."RFQ"')
) THEN
ALTER TABLE ONLY public."RFQ"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocumentLines_OrderItems_OrderItemId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocumentLines_ReceivableDocumentLines_BusinessUni~'
      AND conrelid = to_regclass('public."ReceivableDocumentLines"')
) THEN
ALTER TABLE ONLY public."ReceivableDocumentLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocumentLines_ReceivableDocuments_BusinessUnitId_~'
      AND conrelid = to_regclass('public."ReceivableDocumentLines"')
) THEN
ALTER TABLE ONLY public."ReceivableDocumentLines"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocuments_CommercialCases_BusinessUnitId_Commerci~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocuments_Currency_CurrencyId'
      AND conrelid = to_regclass('public."ReceivableDocuments"')
) THEN
ALTER TABLE ONLY public."ReceivableDocuments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocuments_Customers_CustomerId'
      AND conrelid = to_regclass('public."ReceivableDocuments"')
) THEN
ALTER TABLE ONLY public."ReceivableDocuments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocuments_Orders_BusinessUnitId_OrderId'
      AND conrelid = to_regclass('public."ReceivableDocuments"')
) THEN
ALTER TABLE ONLY public."ReceivableDocuments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableDocuments_ReceivableDocuments_BusinessUnitId_Paren'
      AND conrelid = to_regclass('public."ReceivableDocuments"')
) THEN
ALTER TABLE ONLY public."ReceivableDocuments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableWriteOffs_CommercialCases_BusinessUnitId_Commerci~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableWriteOffs_Currency_CurrencyId'
      AND conrelid = to_regclass('public."ReceivableWriteOffs"')
) THEN
ALTER TABLE ONLY public."ReceivableWriteOffs"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReceivableWriteOffs_Customers_CustomerId'
      AND conrelid = to_regclass('public."ReceivableWriteOffs"')
) THEN
ALTER TABLE ONLY public."ReceivableWriteOffs"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationAllocations_BankStatementLines_BusinessUnitId~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationAllocations_JournalEntryLines_BusinessUnitId_~'
      AND conrelid = to_regclass('public."ReconciliationAllocations"')
) THEN
ALTER TABLE ONLY public."ReconciliationAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationAllocations_ReconciliationMatches_BusinessUni~'
      AND conrelid = to_regclass('public."ReconciliationAllocations"')
) THEN
ALTER TABLE ONLY public."ReconciliationAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationMatches_BankMatchingRules_BusinessUnitId_Bank~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationMatches_ReconciliationRuns_BusinessUnitId_Rec~'
      AND conrelid = to_regclass('public."ReconciliationMatches"')
) THEN
ALTER TABLE ONLY public."ReconciliationMatches"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationRunRules_BankMatchingRules_BusinessUnitId_Ban~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationRunRules_ReconciliationRuns_BusinessUnitId_Re~'
      AND conrelid = to_regclass('public."ReconciliationRunRules"')
) THEN
ALTER TABLE ONLY public."ReconciliationRunRules"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationRuns_BankAccounts_BusinessUnitId_BankAccountId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ReconciliationRuns_BankStatements_BusinessUnitId_BankStatem~'
      AND conrelid = to_regclass('public."ReconciliationRuns"')
) THEN
ALTER TABLE ONLY public."ReconciliationRuns"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Rfqitems_SupplierQuotedItems'
      AND conrelid = to_regclass('public."RFQItems"')
) THEN
ALTER TABLE ONLY public."RFQItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ShipmentItems_OrderItems'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ShipmentItems_Shipments'
      AND conrelid = to_regclass('public."ShipmentItems"')
) THEN
ALTER TABLE ONLY public."ShipmentItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ShipmentStatusHistory_NewStatus'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ShipmentStatusHistory_PreviousStatus'
      AND conrelid = to_regclass('public."ShipmentStatusHistory"')
) THEN
ALTER TABLE ONLY public."ShipmentStatusHistory"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ShipmentStatusHistory_Shipments'
      AND conrelid = to_regclass('public."ShipmentStatusHistory"')
) THEN
ALTER TABLE ONLY public."ShipmentStatusHistory"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Shipments_BusinessUnits'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Shipments_CommercialCases_BusinessUnitID_CommercialCaseId'
      AND conrelid = to_regclass('public."Shipments"')
) THEN
ALTER TABLE ONLY public."Shipments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Shipments_Orders'
      AND conrelid = to_regclass('public."Shipments"')
) THEN
ALTER TABLE ONLY public."Shipments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Shipments_SetCity_BusinessUnitID_DeliveryCityID'
      AND conrelid = to_regclass('public."Shipments"')
) THEN
ALTER TABLE ONLY public."Shipments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SourcingAwards_Currency_BusinessUnitId_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SourcingAwards_RFQItems_RfqItemId_RfqId'
      AND conrelid = to_regclass('public."SourcingAwards"')
) THEN
ALTER TABLE ONLY public."SourcingAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SourcingAwards_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public."SourcingAwards"')
) THEN
ALTER TABLE ONLY public."SourcingAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SourcingAwards_SupplierQuotedItems_BusinessUnitId_SupplierQ~'
      AND conrelid = to_regclass('public."SourcingAwards"')
) THEN
ALTER TABLE ONLY public."SourcingAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SourcingAwards_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public."SourcingAwards"')
) THEN
ALTER TABLE ONLY public."SourcingAwards"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_State_BusinessUnit'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_State_Country'
      AND conrelid = to_regclass('public."SetState"')
) THEN
ALTER TABLE ONLY public."SetState"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierPurchaseHistory_Products'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierPurchaseHistory_Suppliers'
      AND conrelid = to_regclass('public."SupplierPurchaseHistory"')
) THEN
ALTER TABLE ONLY public."SupplierPurchaseHistory"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_BusinessUnits'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_Currency'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_Products_BusinessUnitId_ProductId'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_RFQItems_RfqItemId_RfqId'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_SetUoms'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_SupplierSolicitations_BusinessUnitId_Su~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_Suppliers'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_commercial_demand_lines_BusinessUnitId_~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_sourcing_cases_BusinessUnitId_SourcingC~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_supplier_quote_lines_BusinessUnitId_Sou~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_supplier_quote_revisions_BusinessUnitId~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierQuotedItems_supplier_quotes_BusinessUnitId_SourceSu~'
      AND conrelid = to_regclass('public."SupplierQuotedItems"')
) THEN
ALTER TABLE ONLY public."SupplierQuotedItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierSolicitations_RFQ_BusinessUnitId_RfqId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierSolicitations_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public."SupplierSolicitations"')
) THEN
ALTER TABLE ONLY public."SupplierSolicitations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierSolicitations_commercial_demand_lines_BusinessUnitI~'
      AND conrelid = to_regclass('public."SupplierSolicitations"')
) THEN
ALTER TABLE ONLY public."SupplierSolicitations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_SupplierSolicitations_sourcing_cases_BusinessUnitId_Sourcin~'
      AND conrelid = to_regclass('public."SupplierSolicitations"')
) THEN
ALTER TABLE ONLY public."SupplierSolicitations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Suppliers_City'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Suppliers_Country'
      AND conrelid = to_regclass('public."Suppliers"')
) THEN
ALTER TABLE ONLY public."Suppliers"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Taxes_BusinessUnits'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UserColumnPreferences_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_UserColumnPreferences_Users_UserId'
      AND conrelid = to_regclass('public."UserColumnPreferences"')
) THEN
ALTER TABLE ONLY public."UserColumnPreferences"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_Warehouses_BusinessUnits'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_WriteOffAllocations_ReceivableDocuments_BusinessUnitId_Rece~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_WriteOffAllocations_ReceivableWriteOffs_BusinessUnitId_Rece~'
      AND conrelid = to_regclass('public."WriteOffAllocations"')
) THEN
ALTER TABLE ONLY public."WriteOffAllocations"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Contacts__Custom__17F790F9'
      AND conrelid = to_regclass('public."Contacts"')
) THEN
ALTER TABLE ONLY public."Contacts"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Currency__Busine__4E88ABD4'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Customers__BUID__0D7A0286'
      AND conrelid = to_regclass('public."Customers"')
) THEN
ALTER TABLE ONLY public."Customers"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__EmailInge__Email__503BEA1C'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Email_Con__Busin__489AC854'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Inventory__Busin__534D60F1'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Inventory__Inven__42E1EEFE'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Inventory__Paren__52593CB8'
      AND conrelid = to_regclass('public."ProductCategories"')
) THEN
ALTER TABLE ONLY public."ProductCategories"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Inventory__Uploa__44CA3770'
      AND conrelid = to_regclass('public."ProductAttachments"')
) THEN
ALTER TABLE ONLY public."ProductAttachments"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Leads__BusinessU__55009F39'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Leads__EmailInge__55F4C372'
      AND conrelid = to_regclass('public."Leads"')
) THEN
ALTER TABLE ONLY public."Leads"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__OrderItem__Order__4A18FC72'
      AND conrelid = to_regclass('public."OrderItems"')
) THEN
ALTER TABLE ONLY public."OrderItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__OrderItem__Produ__4B0D20AB'
      AND conrelid = to_regclass('public."OrderItems"')
) THEN
ALTER TABLE ONLY public."OrderItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__OrderItem__UomID__4C0144E4'
      AND conrelid = to_regclass('public."OrderItems"')
) THEN
ALTER TABLE ONLY public."OrderItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__OrderItem__Wareh__4CF5691D'
      AND conrelid = to_regclass('public."OrderItems"')
) THEN
ALTER TABLE ONLY public."OrderItems"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__Business__3F9B6DFF'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__Currency__436BFEE3'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__Customer__3EA749C6'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__LeadID__3CBF0154'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__PaymentM__4183B671'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__PaymentS__4277DAAA'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__QuoteID__3BCADD1B'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__RFQID__3DB3258D'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Orders__StatusID__408F9238'
      AND conrelid = to_regclass('public."Orders"')
) THEN
ALTER TABLE ONLY public."Orders"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Products__BUID'
      AND conrelid = to_regclass('public."Products"')
) THEN
ALTER TABLE ONLY public."Products"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Products__Categ'
      AND conrelid = to_regclass('public."Products"')
) THEN
ALTER TABLE ONLY public."Products"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Products__Prefe'
      AND conrelid = to_regclass('public."Products"')
) THEN
ALTER TABLE ONLY public."Products"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Products__Wareh'
      AND conrelid = to_regclass('public."Products"')
) THEN
ALTER TABLE ONLY public."Products"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__RolePermi__Busin__05D8E0BE'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__RolePermi__Modul__04E4BC85'
      AND conrelid = to_regclass('public."RolePermissions"')
) THEN
ALTER TABLE ONLY public."RolePermissions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__RolePermi__RoleI__03F0984C'
      AND conrelid = to_regclass('public."RolePermissions"')
) THEN
ALTER TABLE ONLY public."RolePermissions"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Setup_Mas__Busin__68487DD7'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Setup_Mas__Paren__6754599E'
      AND conrelid = to_regclass('public."Setup_Master"')
) THEN
ALTER TABLE ONLY public."Setup_Master"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Suppliers__BUID__1332DBDC'
      AND conrelid = to_regclass('public."Suppliers"')
) THEN
ALTER TABLE ONLY public."Suppliers"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Suppliers__Curre__123EB7A3'
      AND conrelid = to_regclass('public."Suppliers"')
) THEN
ALTER TABLE ONLY public."Suppliers"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Teams__BusinessU__70DDC3D8'
      AND conrelid = to_regclass('public."Teams"')
) THEN
ALTER TABLE ONLY public."Teams"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Teams__SubTeamID__6FE99F9F'
      AND conrelid = to_regclass('public."Teams"')
) THEN
ALTER TABLE ONLY public."Teams"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__UserGroup__Busin__73BA3083'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Users__BUID__7D439ABD'
      AND conrelid = to_regclass('public."Users"')
) THEN
ALTER TABLE ONLY public."Users"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Users__RoleID__7B5B524B'
      AND conrelid = to_regclass('public."Users"')
) THEN
ALTER TABLE ONLY public."Users"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Users__TeamID__7C4F7684'
      AND conrelid = to_regclass('public."Users"')
) THEN
ALTER TABLE ONLY public."Users"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK__Users__UserGroup__7E37BEF6'
      AND conrelid = to_regclass('public."Users"')
) THEN
ALTER TABLE ONLY public."Users"
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_canonical_inquiries_Leads_business_unit_id_lead_id'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_canonical_inquiries_document_corpora_business_unit_id_corpu~'
      AND conrelid = to_regclass('public.canonical_inquiries')
) THEN
ALTER TABLE ONLY public.canonical_inquiries
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_canonical_line_items_canonical_inquiries_business_unit_id_i~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_demand_lines_RFQItems_RfqItemId_RfqId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_demand_lines_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.commercial_demand_lines')
) THEN
ALTER TABLE ONLY public.commercial_demand_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_document_classifications_source_documents_busine~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_cases_CommercialCases_BusinessUnitId_C~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_cases_delivery_proof_lines_BusinessUni~'
      AND conrelid = to_regclass('public.commercial_exception_cases')
) THEN
ALTER TABLE ONLY public.commercial_exception_cases
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_cases_follow_up_tasks_BusinessUnitId_F~'
      AND conrelid = to_regclass('public.commercial_exception_cases')
) THEN
ALTER TABLE ONLY public.commercial_exception_cases
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_cases_unassigned_work_items_BusinessUn~'
      AND conrelid = to_regclass('public.commercial_exception_cases')
) THEN
ALTER TABLE ONLY public.commercial_exception_cases
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_events_commercial_exception_cases_Busi~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_operations_commercial_exception_cases_~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_exception_outbox_commercial_exception_events_Bus~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_lifecycle_events_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_lifecycle_events_CommercialCases_BusinessUnitId_~'
      AND conrelid = to_regclass('public.commercial_lifecycle_events')
) THEN
ALTER TABLE ONLY public.commercial_lifecycle_events
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_lifecycle_events_Setup_Master_BusinessUnitId_New~'
      AND conrelid = to_regclass('public.commercial_lifecycle_events')
) THEN
ALTER TABLE ONLY public.commercial_lifecycle_events
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_lifecycle_events_Setup_Master_BusinessUnitId_Pre~'
      AND conrelid = to_regclass('public.commercial_lifecycle_events')
) THEN
ALTER TABLE ONLY public.commercial_lifecycle_events
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_events_commercial_opportunity_recomm~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_feedback_commercial_opportunity_feed~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_feedback_commercial_opportunity_reco~'
      AND conrelid = to_regclass('public.commercial_opportunity_feedback')
) THEN
ALTER TABLE ONLY public.commercial_opportunity_feedback
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_operations_commercial_opportunity_re~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_outbox_commercial_opportunity_events~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_outcomes_commercial_opportunity_reco~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_recommendations_CommercialCases_Busi~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_recommendations_Leads_BusinessUnitId~'
      AND conrelid = to_regclass('public.commercial_opportunity_recommendations')
) THEN
ALTER TABLE ONLY public.commercial_opportunity_recommendations
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_commercial_opportunity_recommendations_commercial_opportuni~'
      AND conrelid = to_regclass('public.commercial_opportunity_recommendations')
) THEN
ALTER TABLE ONLY public.commercial_opportunity_recommendations
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_dependencies_custom_field_definitions_DependsO~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_dependencies_custom_field_versions_VersionId'
      AND conrelid = to_regclass('public.custom_field_dependencies')
) THEN
ALTER TABLE ONLY public.custom_field_dependencies
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_options_custom_field_versions_VersionId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_rules_custom_field_versions_VersionId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_values_custom_field_definitions_BusinessUnitId~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_values_custom_field_records_BusinessUnitId_Rec~'
      AND conrelid = to_regclass('public.custom_field_values')
) THEN
ALTER TABLE ONLY public.custom_field_values
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_values_custom_field_versions_DefinitionId_Defi~'
      AND conrelid = to_regclass('public.custom_field_values')
) THEN
ALTER TABLE ONLY public.custom_field_values
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_custom_field_versions_custom_field_definitions_DefinitionId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_identifiers_Customers_CustomerId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_owner_tenant_backup_user'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_owner_tenant_primary_user'
      AND conrelid = to_regclass('public.customer_ownerships')
) THEN
ALTER TABLE ONLY public.customer_ownerships
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_ownerships_Customers_BusinessUnitId_CustomerId'
      AND conrelid = to_regclass('public.customer_ownerships')
) THEN
ALTER TABLE ONLY public.customer_ownerships
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_QuoteItems_QuoteItemId_Qu~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_Quotes_BusinessUnitId_Quo~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_SourcingAwards_BusinessUn~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_SupplierQuotedItems_Busin~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_commercial_demand_lines_B~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_sourcing_cases_BusinessUn~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_supplier_quote_lines_Busi~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_supplier_quote_revisions_~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_customer_quote_sourcing_decisions_supplier_quotes_BusinessU~'
      AND conrelid = to_regclass('public.customer_quote_sourcing_decisions')
) THEN
ALTER TABLE ONLY public.customer_quote_sourcing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proof_lines_OrderItems_OrderItemId_OrderId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proof_lines_Orders_BusinessUnitId_OrderId'
      AND conrelid = to_regclass('public.delivery_proof_lines')
) THEN
ALTER TABLE ONLY public.delivery_proof_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proof_lines_ShipmentItems_ShipmentItemId_ShipmentId'
      AND conrelid = to_regclass('public.delivery_proof_lines')
) THEN
ALTER TABLE ONLY public.delivery_proof_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proof_lines_Shipments_BusinessUnitId_ShipmentId'
      AND conrelid = to_regclass('public.delivery_proof_lines')
) THEN
ALTER TABLE ONLY public.delivery_proof_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proof_lines_delivery_proofs_BusinessUnitId_Deliver~'
      AND conrelid = to_regclass('public.delivery_proof_lines')
) THEN
ALTER TABLE ONLY public.delivery_proof_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proofs_Attachments_PhotoEvidenceId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proofs_Attachments_SignatureEvidenceId'
      AND conrelid = to_regclass('public.delivery_proofs')
) THEN
ALTER TABLE ONLY public.delivery_proofs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proofs_Attachments_StampEvidenceId'
      AND conrelid = to_regclass('public.delivery_proofs')
) THEN
ALTER TABLE ONLY public.delivery_proofs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proofs_CommercialCases_BusinessUnitId_CommercialCa~'
      AND conrelid = to_regclass('public.delivery_proofs')
) THEN
ALTER TABLE ONLY public.delivery_proofs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_proofs_Shipments_BusinessUnitId_ShipmentId'
      AND conrelid = to_regclass('public.delivery_proofs')
) THEN
ALTER TABLE ONLY public.delivery_proofs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_shortfall_decisions_Shipments_BusinessUnitId_Shipm~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_delivery_shortfall_decisions_delivery_proof_lines_BusinessU~'
      AND conrelid = to_regclass('public.delivery_shortfall_decisions')
) THEN
ALTER TABLE ONLY public.delivery_shortfall_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_document_pages_source_documents_business_unit_id_document_id'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_document_regions_document_pages_business_unit_id_page_id'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_evidence_retention_policies_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_extraction_dead_letter_events_ExtractionJobs_BusinessUnitId~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_extraction_runs_ExtractionJobs_business_unit_id_extraction_j'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_extraction_runs_source_documents_business_unit_id_source_do~'
      AND conrelid = to_regclass('public.extraction_runs')
) THEN
ALTER TABLE ONLY public.extraction_runs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_field_evidence_canonical_inquiries_business_unit_id_inquiry~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_field_evidence_canonical_line_items_business_unit_id_line_i~'
      AND conrelid = to_regclass('public.field_evidence')
) THEN
ALTER TABLE ONLY public.field_evidence
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_field_evidence_document_regions_business_unit_id_region_id'
      AND conrelid = to_regclass('public.field_evidence')
) THEN
ALTER TABLE ONLY public.field_evidence
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_field_evidence_extraction_runs_business_unit_id_run_id'
      AND conrelid = to_regclass('public.field_evidence')
) THEN
ALTER TABLE ONLY public.field_evidence
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_follow_up_event_tenant_task'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_follow_up_tenant_customer'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_follow_up_tenant_user'
      AND conrelid = to_regclass('public.follow_up_tasks')
) THEN
ALTER TABLE ONLY public.follow_up_tasks
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_goods_receipt_lines_goods_receipts_BusinessUnitId_GoodsRece~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_goods_receipt_lines_inventory_movements_BusinessUnitId_Inve~'
      AND conrelid = to_regclass('public.goods_receipt_lines')
) THEN
ALTER TABLE ONLY public.goods_receipt_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_goods_receipt_lines_supplier_purchase_order_lines_BusinessU~'
      AND conrelid = to_regclass('public.goods_receipt_lines')
) THEN
ALTER TABLE ONLY public.goods_receipt_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_goods_receipts_Warehouses_BusinessUnitId_WarehouseId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_goods_receipts_supplier_purchase_orders_BusinessUnitId_Supp~'
      AND conrelid = to_regclass('public.goods_receipts')
) THEN
ALTER TABLE ONLY public.goods_receipts
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_governed_artifact_events_governed_artifacts_BusinessUnitId_~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_governed_artifact_versions_governed_artifacts_BusinessUnitI~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_governed_artifacts_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_human_action_events_human_action_items_BusinessUnitId_Human~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_human_action_items_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_inbound_logistics_policies_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_incoming_inventory_Inventory_BusinessUnitId_InventoryId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_incoming_inventory_Products_BusinessUnitId_ProductId'
      AND conrelid = to_regclass('public.incoming_inventory')
) THEN
ALTER TABLE ONLY public.incoming_inventory
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_incoming_inventory_Warehouses_BusinessUnitId_WarehouseId'
      AND conrelid = to_regclass('public.incoming_inventory')
) THEN
ALTER TABLE ONLY public.incoming_inventory
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_inventory_movements_Inventory_BusinessUnitId_InventoryId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_inventory_movements_Products_BusinessUnitId_ProductId'
      AND conrelid = to_regclass('public.inventory_movements')
) THEN
ALTER TABLE ONLY public.inventory_movements
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_inventory_movements_Warehouses_BusinessUnitId_WarehouseId'
      AND conrelid = to_regclass('public.inventory_movements')
) THEN
ALTER TABLE ONLY public.inventory_movements
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_inventory_reorder_alerts_Inventory_BusinessUnitId_Inventory~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignment_tenant_actor'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignment_tenant_from_user'
      AND conrelid = to_regclass('public.lead_assignments')
) THEN
ALTER TABLE ONLY public.lead_assignments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignment_tenant_to_user'
      AND conrelid = to_regclass('public.lead_assignments')
) THEN
ALTER TABLE ONLY public.lead_assignments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignments_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public.lead_assignments')
) THEN
ALTER TABLE ONLY public.lead_assignments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignments_customer_ownerships_BusinessUnitId_Ownersh~'
      AND conrelid = to_regclass('public.lead_assignments')
) THEN
ALTER TABLE ONLY public.lead_assignments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_assignments_lead_routing_decisions_BusinessUnitId_Rout~'
      AND conrelid = to_regclass('public.lead_assignments')
) THEN
ALTER TABLE ONLY public.lead_assignments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_customer_match_candidates_Customers_BusinessUnitId_Cus~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_customer_match_candidates_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public.lead_customer_match_candidates')
) THEN
ALTER TABLE ONLY public.lead_customer_match_candidates
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_decision_tenant_selected_user'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_decision_tenant_suggested_user'
      AND conrelid = to_regclass('public.lead_routing_decisions')
) THEN
ALTER TABLE ONLY public.lead_routing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_LeadItemRevisions_Business~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_LeadRevisions_BusinessUnit~'
      AND conrelid = to_regclass('public.lead_line_commercial_resolutions')
) THEN
ALTER TABLE ONLY public.lead_line_commercial_resolutions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public.lead_line_commercial_resolutions')
) THEN
ALTER TABLE ONLY public.lead_line_commercial_resolutions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_Products_BusinessUnitId_Pr~'
      AND conrelid = to_regclass('public.lead_line_commercial_resolutions')
) THEN
ALTER TABLE ONLY public.lead_line_commercial_resolutions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_RFQItems_RfqItemId_RfqId'
      AND conrelid = to_regclass('public.lead_line_commercial_resolutions')
) THEN
ALTER TABLE ONLY public.lead_line_commercial_resolutions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_line_commercial_resolutions_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.lead_line_commercial_resolutions')
) THEN
ALTER TABLE ONLY public.lead_line_commercial_resolutions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_routing_decisions_Customers_BusinessUnitId_CustomerId'
      AND conrelid = to_regclass('public.lead_routing_decisions')
) THEN
ALTER TABLE ONLY public.lead_routing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_routing_decisions_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public.lead_routing_decisions')
) THEN
ALTER TABLE ONLY public.lead_routing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_routing_decisions_customer_identifiers_BusinessUnitId_~'
      AND conrelid = to_regclass('public.lead_routing_decisions')
) THEN
ALTER TABLE ONLY public.lead_routing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lead_routing_decisions_customer_ownerships_BusinessUnitId_O~'
      AND conrelid = to_regclass('public.lead_routing_decisions')
) THEN
ALTER TABLE ONLY public.lead_routing_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_learning_governance_events_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lifecycle_outbox_messages_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_lifecycle_outbox_messages_commercial_lifecycle_events_Busin~'
      AND conrelid = to_regclass('public.lifecycle_outbox_messages')
) THEN
ALTER TABLE ONLY public.lifecycle_outbox_messages
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_certificates_Attachments_AttachmentId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_certificates_material_lots_BusinessUnitId_Mate~'
      AND conrelid = to_regclass('public.material_lot_certificates')
) THEN
ALTER TABLE ONLY public.material_lot_certificates
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_consumptions_CommercialCases_BusinessUnitId_Co~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_consumptions_OrderItems_OrderItemId_OrderId'
      AND conrelid = to_regclass('public.material_lot_consumptions')
) THEN
ALTER TABLE ONLY public.material_lot_consumptions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_consumptions_Orders_BusinessUnitId_OrderId'
      AND conrelid = to_regclass('public.material_lot_consumptions')
) THEN
ALTER TABLE ONLY public.material_lot_consumptions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_consumptions_Shipments_BusinessUnitId_Shipment~'
      AND conrelid = to_regclass('public.material_lot_consumptions')
) THEN
ALTER TABLE ONLY public.material_lot_consumptions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lot_consumptions_material_lots_BusinessUnitId_Mate~'
      AND conrelid = to_regclass('public.material_lot_consumptions')
) THEN
ALTER TABLE ONLY public.material_lot_consumptions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_CommercialCases_BusinessUnitId_CommercialCase~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_Inventory_BusinessUnitId_InventoryId'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_Products_BusinessUnitId_ProductId'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_Warehouses_BusinessUnitId_WarehouseId'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_goods_receipts_BusinessUnitId_GoodsReceiptId'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_supplier_purchase_order_lines_BusinessUnitId_~'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_material_lots_supplier_purchase_orders_BusinessUnitId_Suppl~'
      AND conrelid = to_regclass('public.material_lots')
) THEN
ALTER TABLE ONLY public.material_lots
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_ports_of_entry_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_callback_receipts_procurement_handoffs_Business~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_events_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_Currency_BusinessUnitId_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_OrderItems_CustomerOrderLineId_Custome~'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_Orders_BusinessUnitId_CustomerOrderId'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_RFQItems_RfqItemId_RfqId'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_SourcingAwards_BusinessUnitId_Sourcing~'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_SupplierQuotedItems_BusinessUnitId_Sup~'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_Warehouses_BusinessUnitId_WarehouseId'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_handoffs_commercial_demand_lines_BusinessUnitId~'
      AND conrelid = to_regclass('public.procurement_handoffs')
) THEN
ALTER TABLE ONLY public.procurement_handoffs
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_procurement_outbox_SupplierSolicitations_BusinessUnitId_Sup~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_product_aliases_Products_BusinessUnitId_ProductId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_product_supersessions_Products_BusinessUnitId_ReplacementPr~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_product_supersessions_Products_BusinessUnitId_SupersededPro~'
      AND conrelid = to_regclass('public.product_supersessions')
) THEN
ALTER TABLE ONLY public.product_supersessions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_quote_delivery_requests_Quotes_BusinessUnitId_QuoteId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_activity_tenant_assignment'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_activity_tenant_customer'
      AND conrelid = to_regclass('public.commercial_activities')
) THEN
ALTER TABLE ONLY public.commercial_activities
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_activity_tenant_user'
      AND conrelid = to_regclass('public.commercial_activities')
) THEN
ALTER TABLE ONLY public.commercial_activities
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_coaching_ack_manager_tenant_user'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_coaching_ack_rep_tenant_user'
      AND conrelid = to_regclass('public.sales_coaching_acknowledgements')
) THEN
ALTER TABLE ONLY public.sales_coaching_acknowledgements
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_coaching_acknowledgements_BusinessUnits_BusinessUnitId'
      AND conrelid = to_regclass('public.sales_coaching_acknowledgements')
) THEN
ALTER TABLE ONLY public.sales_coaching_acknowledgements
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_contribution_tenant_customer'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_contribution_tenant_user'
      AND conrelid = to_regclass('public.sales_contributions')
) THEN
ALTER TABLE ONLY public.sales_contributions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_membership_tenant_team'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_membership_tenant_user'
      AND conrelid = to_regclass('public.sales_team_memberships')
) THEN
ALTER TABLE ONLY public.sales_team_memberships
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sales_profile_tenant_user'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_document_occurrences_ExtractionJobs_business_unit_id_'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_document_occurrences_document_corpora_business_unit_~'
      AND conrelid = to_regclass('public.source_document_occurrences')
) THEN
ALTER TABLE ONLY public.source_document_occurrences
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_document_occurrences_source_document_occurrences_bus~'
      AND conrelid = to_regclass('public.source_document_occurrences')
) THEN
ALTER TABLE ONLY public.source_document_occurrences
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_document_occurrences_source_documents_business_unit_~'
      AND conrelid = to_regclass('public.source_document_occurrences')
) THEN
ALTER TABLE ONLY public.source_document_occurrences
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_documents_ExtractionJobs_business_unit_id_extraction_'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_source_documents_document_corpora_business_unit_id_corpus_id'
      AND conrelid = to_regclass('public.source_documents')
) THEN
ALTER TABLE ONLY public.source_documents
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sourcing_case_candidates_Suppliers_SupplierId_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sourcing_case_candidates_sourcing_cases_BusinessUnitId_Sour~'
      AND conrelid = to_regclass('public.sourcing_case_candidates')
) THEN
ALTER TABLE ONLY public.sourcing_case_candidates
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sourcing_cases_RFQItems_RfqItemId_RfqId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sourcing_cases_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.sourcing_cases')
) THEN
ALTER TABLE ONLY public.sourcing_cases
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_sourcing_cases_commercial_demand_lines_BusinessUnitId_Comme~'
      AND conrelid = to_regclass('public.sourcing_cases')
) THEN
ALTER TABLE ONLY public.sourcing_cases
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_stock_reservations_Inventory_BusinessUnitId_InventoryId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_negotiation_decisions_supplier_quote_revisions_Bus~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_negotiation_decisions_supplier_quotes_BusinessUnit~'
      AND conrelid = to_regclass('public.supplier_negotiation_decisions')
) THEN
ALTER TABLE ONLY public.supplier_negotiation_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_Inventory_BusinessUnitId_Inve~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_Products_BusinessUnitId_Produ~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_RFQItems_RfqItemId_RfqId'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_SourcingAwards_BusinessUnitId~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_SupplierQuotedItems_BusinessU~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_Warehouses_BusinessUnitId_War~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_incoming_inventory_BusinessUn~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_order_lines_supplier_purchase_orders_Busi~'
      AND conrelid = to_regclass('public.supplier_purchase_order_lines')
) THEN
ALTER TABLE ONLY public.supplier_purchase_order_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_orders_CommercialCases_BusinessUnitId_Com~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_orders_Currency_BusinessUnitId_CurrencyId'
      AND conrelid = to_regclass('public.supplier_purchase_orders')
) THEN
ALTER TABLE ONLY public.supplier_purchase_orders
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_orders_RFQ_BusinessUnitId_RfqId'
      AND conrelid = to_regclass('public.supplier_purchase_orders')
) THEN
ALTER TABLE ONLY public.supplier_purchase_orders
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_purchase_orders_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public.supplier_purchase_orders')
) THEN
ALTER TABLE ONLY public.supplier_purchase_orders
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_field_evidence_supplier_quote_lines_Business~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_field_evidence_supplier_quote_revisions_Busi~'
      AND conrelid = to_regclass('public.supplier_quote_field_evidence')
) THEN
ALTER TABLE ONLY public.supplier_quote_field_evidence
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_lines_commercial_demand_lines_BusinessUnitId~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_lines_supplier_quote_revisions_BusinessUnitI~'
      AND conrelid = to_regclass('public.supplier_quote_lines')
) THEN
ALTER TABLE ONLY public.supplier_quote_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_review_decisions_supplier_quote_field_eviden~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_review_decisions_supplier_quote_revisions_Bu~'
      AND conrelid = to_regclass('public.supplier_quote_review_decisions')
) THEN
ALTER TABLE ONLY public.supplier_quote_review_decisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_revisions_Currency_BusinessUnitId_CurrencyId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_revisions_source_documents_BusinessUnitId_So~'
      AND conrelid = to_regclass('public.supplier_quote_revisions')
) THEN
ALTER TABLE ONLY public.supplier_quote_revisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quote_revisions_supplier_quotes_BusinessUnitId_Sup~'
      AND conrelid = to_regclass('public.supplier_quote_revisions')
) THEN
ALTER TABLE ONLY public.supplier_quote_revisions
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quotes_RFQ_BusinessUnitId_RfqId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quotes_SupplierSolicitations_BusinessUnitId_Suppli~'
      AND conrelid = to_regclass('public.supplier_quotes')
) THEN
ALTER TABLE ONLY public.supplier_quotes
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quotes_Suppliers_SupplierId_BusinessUnitId'
      AND conrelid = to_regclass('public.supplier_quotes')
) THEN
ALTER TABLE ONLY public.supplier_quotes
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_quotes_sourcing_cases_BusinessUnitId_SourcingCaseId'
      AND conrelid = to_regclass('public.supplier_quotes')
) THEN
ALTER TABLE ONLY public.supplier_quotes
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_shipment_lines_Products_BusinessUnitId_ProductId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_shipment_lines_supplier_purchase_order_lines_Busin~'
      AND conrelid = to_regclass('public.supplier_shipment_lines')
) THEN
ALTER TABLE ONLY public.supplier_shipment_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_shipment_lines_supplier_shipments_BusinessUnitId_S~'
      AND conrelid = to_regclass('public.supplier_shipment_lines')
) THEN
ALTER TABLE ONLY public.supplier_shipment_lines
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_shipments_ports_of_entry_BusinessUnitId_PortOfEntr~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_supplier_shipments_supplier_purchase_orders_BusinessUnitId_~'
      AND conrelid = to_regclass('public.supplier_shipments')
) THEN
ALTER TABLE ONLY public.supplier_shipments
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_tenant_governance_audit_events_BusinessUnits_BusinessUnitId'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_unassigned_tenant_claimed_user'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_unassigned_tenant_suggested_customer'
      AND conrelid = to_regclass('public.unassigned_work_items')
) THEN
ALTER TABLE ONLY public.unassigned_work_items
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_unassigned_tenant_suggested_user'
      AND conrelid = to_regclass('public.unassigned_work_items')
) THEN
ALTER TABLE ONLY public.unassigned_work_items
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_unassigned_work_items_Leads_BusinessUnitId_LeadId'
      AND conrelid = to_regclass('public.unassigned_work_items')
) THEN
ALTER TABLE ONLY public.unassigned_work_items
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_unassigned_work_items_lead_routing_decisions_BusinessUnitId~'
      AND conrelid = to_regclass('public.unassigned_work_items')
) THEN
ALTER TABLE ONLY public.unassigned_work_items
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_validation_findings_canonical_inquiries_business_unit_id_in~'
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_validation_findings_canonical_line_items_business_unit_id_l~'
      AND conrelid = to_regclass('public.validation_findings')
) THEN
ALTER TABLE ONLY public.validation_findings
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_validation_findings_document_regions_business_unit_id_regio~'
      AND conrelid = to_regclass('public.validation_findings')
) THEN
ALTER TABLE ONLY public.validation_findings
...
IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
    WHERE conname = 'FK_validation_findings_extraction_runs_business_unit_id_extrac~'
      AND conrelid = to_regclass('public.validation_findings')
) THEN
ALTER TABLE ONLY public.validation_findings
