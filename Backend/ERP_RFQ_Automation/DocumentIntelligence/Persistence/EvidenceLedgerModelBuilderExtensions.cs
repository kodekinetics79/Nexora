        ...
        modelBuilder.Entity<SourceDocumentOccurrence>(entity =>
        {
            entity.ToTable("source_document_occurrences", table =>
            {
                ...
                table.HasCheckConstraint("ck_source_document_occurrences_outcome_state",
                    "outcome_state IN ('NONE','EXACT_DUPLICATE_PENDING_SECURITY','EXACT_DUPLICATE_CONFIRMED','BUSINESS_DUPLICATE_CONFIRMED','DUPLICATE_RESCAN_REQUIRED','REVISION','POSSIBLE_MATCH','SECURITY_SCAN_BLOCKED','MALWARE_DETECTED','UNSUPPORTED_FORMAT','SOURCE_OBJECT_UNAVAILABLE','EVIDENCE_INTEGRITY_FAILURE','AI_NOT_AUTHORIZED')");
