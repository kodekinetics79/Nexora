...
public sealed class ReleaseSimulationService(ErpRfqAutomationContext db)
{
        ...
        long testSuiteId, string idempotencyKey, CancellationToken ct)
    {
        ...
        {
            BusinessUnitId = tenantId, Area = "ReleaseCenter", AggregateType = "TestSuite",
            ...
            EvidenceJson = JsonSerializer.Serialize(result), IdempotencyKey = idempotencyKey,
            ActorUserId = actorUserId, OccurredOn = now
        });
