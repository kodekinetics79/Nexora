...
import type {
  ActivationRemediationAction, RateCard, RegisterTenantDataAssetInput, Tenant,
 ...
 *
 * Which step that is, is a fact about the registry rather than a decision for the operator to get
 * wrong, so the dialog reads the assets and shows the right form. Nothing on the verify form is
 * pre-filled: every field on it is an OBSERVATION from an external probe, and a form that
 * suggested the answer would be manufacturing the evidence it exists to record.
 */
