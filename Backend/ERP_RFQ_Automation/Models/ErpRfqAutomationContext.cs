...
public partial class ErpRfqAutomationContext : DbContext
{
    ...
    public override int SaveChanges(bool acceptAllChangesOnSuccess)
    {
        ...
        // Same reason, one subsystem over: Tenant.Version is a plain long, so nothing
        // increments it unless something here does, and an unincremented token is inert.
        ERP_RFQ_Automation.Platform.Models.TenantConcurrencyStamp.Stamp(ChangeTracker);
