...
export default function RoutingQueuePage() {
  ...
  const query = useQuery({ queryKey: ['commercial-intelligence', 'routing-queue', sourceId], queryFn: () => commercialIntelligenceService.getRoutingQueue({ sourceId }), refetchInterval: 60_000, meta: { silenceGlobalError: true } });
