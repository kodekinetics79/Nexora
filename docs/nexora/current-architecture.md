...
- Opportunity scoring uses deterministic exact-part coverage, canonical customer identity, extraction confidence, deadline, and current commercial stage. Ambiguous matches, raw stock quantities, mixed-currency values, and margin are excluded. Accuracy remains unavailable until an adequate later-outcome cohort exists.
