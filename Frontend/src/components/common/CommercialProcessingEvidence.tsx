...
// What a client sees here is the finished product: how the document was read and the record that
// traces it. Which model or provider did the reading, and what it cost Nexora, is platform-level
// raw material and stays in Platform Admin (owner decision, 2026-09-16).
export default function CommercialProcessingEvidence({
  ...
  return <Paper variant="outlined" sx={{ mb: 2, p: 2 }}>
    ...
    {expanded && <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr 1fr' }, gap: 2, mt: 2, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
