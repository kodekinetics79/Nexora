...
export const TERMINAL_BLOCKERS: ReadonlySet<string> = new Set(['LEGACY_RFQ', 'INCONSISTENT_CONVERTED_STATE', 'RFQ_REVISION_REQUIRED']);
...
export const decisionRecordIsLocked = (
  ...
  if (workbench.blockers.some(({ code }) => TERMINAL_BLOCKERS.has(code))) return true;
