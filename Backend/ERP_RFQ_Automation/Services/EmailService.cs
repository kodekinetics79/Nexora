            ...
            try
            {
                ...
                try
                {
                    ...
                    var lead = new Lead
                    {
                        ...
                        RequiredDeliveryDate = ParseDate(ai.RequiredDeliveryDate),
                        DeliveryLocation = Truncate(ai.DeliveryLocation?.Trim(), 500),
                        AgreementReference = Truncate(ai.AgreementReference?.Trim(), 100),
