...
const OutstandingLeadsPage: React.FC = () => {
  ...
  const noRowsOverlay = React.useMemo(() => gridEmptyOverlay({
    ...
    message: 'Accepted Leads appear here until assigned. The owner then chooses which lines to quote on the Decide screen; only lines marked to quote go into the RFQ.',
